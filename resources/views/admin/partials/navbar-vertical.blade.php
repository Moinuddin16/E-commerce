 ...
 <nav class="navbar-vertical navbar">
     <div class="nav-scroller">
         ...
         <ul class="navbar-nav flex-column" id="sideNavbar">
             ...
             <li class="nav-item active">
                 <a class="nav-link " href="{{url('admin/employee-info/')}}">
                     <i data-feather="home" class="nav-icon icon-xs me-2"></i>Employee Info
                 </a>

             </li>
             <li class="nav-item active">
                 <a class="nav-link " href="{{url('admin/employee-attendance/')}}">
                     <i data-feather="home" class="nav-icon icon-xs me-2"></i>Employee Attendance
                 </a>

             </li>
             <li class="nav-item active">
                 <a class="nav-link " href="{{url('admin/employee-attendance-report/')}}">
                     <i data-feather="home" class="nav-icon icon-xs me-2"></i>Attendance Report
                 </a>
